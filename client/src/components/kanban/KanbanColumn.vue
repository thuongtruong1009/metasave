...
defineProps<{
  column: IColumn;
  getCardPayload: (columnId: string) => any;
}>();

// const emit = defineEmits(["cardDrop"]);
const emit = defineEmits<{
  (payload: any, columnId: string): void;
  (e: "unClose", id: number): void;
}>();
const onCardDrop = (payload: any, columnId: string) => {
  emit("cardDrop", payload, columnId);
};
